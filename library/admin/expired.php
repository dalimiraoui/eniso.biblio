...
<?php
        ...
        {   ?>
            ...
            <form method="post" action="">
                    ...
                    <button type="submit" name="submit3" class="btn btn-default"style="background-color:red;">EXPIRED</button></div>
            </form>
                <div class="srch">
            ...
            if(isset($_POST['submit']))
            {
                ...
                mysqli_query($db,"UPDATE books SET quantity=quantity+1 where bid='$_POST[username]'and bid='$_POST[bid]'");
